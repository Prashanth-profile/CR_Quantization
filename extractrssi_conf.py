...
#########################################RSSI########################################
#Read the text file
with open('C:/Users/prashanth/Desktop/RSSI_SC_1109_SDR1.txt', 'r') as fin:
...
with open('C:/Users/prashanth/Desktop/RSSI_SC_1109_SDR2.txt', 'r') as fin:
...
#######################################RSSI HighRes##############################################
#Read the text file
with open('C:/Users/prashanth/Desktop/RSSI_SC_1109_SDR1_highres.txt', 'r') as fin:
    data_read_SDR1 = fin.read()
    last_char_SDR1 = data_read_SDR1[-1]
    if last_char_SDR1 == '\n':
        print("last next line character detected in first sample file")
        data_read_SDR1 = data_read_SDR1[:-1]
with open('C:/Users/prashanth/Desktop/RSSI_SC_1109_SDR2_highres.txt', 'r') as fin:
    data_read_SDR2 = fin.read()
    last_char_SDR2 = data_read_SDR2[-1]
    if last_char_SDR2 == '\n':
        print("last next line character detected in second sample file")

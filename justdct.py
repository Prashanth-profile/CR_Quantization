...
confidence_interval.plot_confidence_interval(np.array(DCT_2.CR_rate).reshape(num_columns, num_rows).transpose(), np.array(quan_size), labelarray, axis3, "DCT $I=$2", 'cyan', mark)
confidence_interval.plot_confidence_interval(np.array(DCT_4.CR_rate).reshape(num_columns, num_rows).transpose(), np.array(quan_size), labelarray, axis3, "DCT $I=$4", 'blue', mark)
confidence_interval.plot_confidence_interval(np.array(DCT_n_4.CR_rate).reshape(num_columns, num_rows).transpose(), np.array(quan_size), labelarray, axis3, "DCT $I=n/$4", 'brown', mark)
confidence_interval.plot_confidence_interval(np.array(DCT_n_3.CR_rate).reshape(num_columns, num_rows).transpose(), np.array(quan_size), labelarray, axis3, "DCT $I=n/$3", 'black', mark)
confidence_interval.plot_confidence_interval(np.array(DCT_n_2.CR_rate).reshape(num_columns, num_rows).transpose(), np.array(quan_size), labelarray, axis3, "DCT $I=n/$2", 'red', mark)
confidence_interval.plot_confidence_interval(np.array(No_Filter_8.CR_rate).reshape(num_columns, num_rows).transpose(), np.array(quan_size), labelarray, axis3, "NF RSSI", 'yellow', mark)

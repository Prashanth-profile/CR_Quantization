...
plt2.rcParams.update({'font.family': 'Times New Roman', 'font.size': 30,})
...
corr_coeff_po, number_of_samples_po = correlation_calculation.complete_correlation(min_length, list_of_floats_SDR1,
                                                                             list_of_floats_SDR2)
...
corr_coeff_vol, number_of_samples_vol = correlation_calculation.complete_correlation(min_length, list_of_floats_SDR1,
                                                                             list_of_floats_SDR2)
...
#plot_correlation.correlation_plot(number_of_samples_smoothcfo, corr_coeff_smoothcfo, axis, 'g-', "Smoothened CFO")
#plot_correlation.correlation_plot(number_of_samples_smoothrssi, corr_coeff_smoothrssi, axis, 'k-', "Smoothened RSSI")

#######################################PO##############################################
#Read the text file
plt2.rcParams['font.family'] = 'Times New Roman'  # Specify the font family
plt2.rcParams['font.size'] = 30  # Specify the font size
plt2.xticks(fontsize=30)  # Specify the font size for x-axis tick labels
plt2.yticks(fontsize=30)  # Specify the font size for y-axis tick labels
plt2.show()
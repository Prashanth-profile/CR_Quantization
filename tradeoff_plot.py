...
#y1 = [2048, 2048, 1024, 256, 256, 256]
#y2 = [12*8, 72*8, 42*8, 402*8, 420*8, 6*8]

#ECC Results n vs P
#x = np.arange(1, 8)
#y1 = [2048, 2048, 1024, 512, 512, 256, 256]
#y2 = [24, 72, 144, 1008, 1020, 72, 0]
...
#plt.bar(x + 0.2, y2, width=0.4, label='Min. Nr. of parity bytes', color='green')

...
def lossy_quantization(list_of_floats_SDR1, list_of_floats_SDR2, min_length, window_size, mean_medianbar, alpha):
    lossquantizedbits_SDR1 = window_average_threshold_quantization.float_to_binary_lossyquantization_onebit(list_of_floats_SDR1, window_size, mean_medianbar, alpha)
    lossquantizedbits_SDR2 = window_average_threshold_quantization.float_to_binary_lossyquantization_onebit(list_of_floats_SDR2, window_size, mean_medianbar, alpha)
